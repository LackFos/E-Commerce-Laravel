        ...
        <div class='flex w-1/4 flex-col justify-start gap-6'>
            <div class='flex w-full flex-col rounded-2xl border border-solid border-gray-100 bg-white'>
                <div class='flex h-32 items-center justify-start gap-6 p-6'>
                    <div class='h-20 w-20 rounded-full bg-gray-300'></div><span>John Doe</span>
                </div>
            ...
            <div class='flex h-16 items-center justify-start gap-4 rounded-2xl bg-white px-6 py-4'>
                <x-icons.logout />
                <a href='/' class='text-base text-red-500'>Keluar akun</a>
            </div>
        </div>
