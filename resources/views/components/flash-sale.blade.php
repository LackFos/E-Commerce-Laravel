<div class="flex flex-col gap-4 rounded-lg bg-[#f8f9fb] py-6">
    ...
    <div class="relative">
        <div class="swiper-button-prev-fs absolute left-[-2rem] top-[-14rem] flex h-14 w-14 items-center justify-center rounded-full bg-white p-3 text-2xl text-gray-400">
            <x-icons.chevron class="rotate-180" />
        </div>
        <div class="swiper-button-next-fs absolute right-[-2rem] top-[-14rem] flex h-14 w-14 items-center justify-center rounded-full bg-white p-3 text-2xl text-gray-400">
            <x-icons.chevron />
        </div>
    </div>
</div>
