        ...
        <div
            ...
            <form action="" method="post" class='flex flex-col gap-6'>
                ...
                <div class='flex flex-col gap-4'>
                    <input
                        class='px-6 py-3 bg-white border border-gray-100 border-solid h-14 w-96 rounded-2xl focus:border-primary focus:shadow-input focus:outline-none'
                ...
                <div class='flex flex-col gap-8'>
                    ...
                    <div>
                        <button
                            class='text-base font-semibold text-white h-14 w-96 rounded-2xl bg-primary hover:bg-opacity-75'>Masuk</button>
                    </div>
