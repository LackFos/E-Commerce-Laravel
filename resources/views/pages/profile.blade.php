        ...
        <div class='flex w-full flex-col gap-8 rounded-2xl bg-white p-6'>
            ...
            <div class='flex flex-col gap-6'>
                <div class='flex justify-start gap-6 pr-16'>
                    ...
                    <input type="text" name='nama' class='w-4/5 rounded-lg border border-solid px-4 py-1'>
                </div>
                <div class='flex justify-start gap-6 pr-16'>
                    <div class='flex w-60 items-center justify-start'><span>Email</span></div>
                    <input type="text" name='Email' class='w-4/5 rounded-lg border border-solid px-4 py-1'>
                </div>
                <div class='flex justify-start gap-6 pr-16'>
                    <div class='flex w-60 items-center justify-start'><span>Nomor Handphone</span></div>
                    <input type="text" name='Nomor Handphone' class='w-4/5 rounded-lg border border-solid px-4 py-1'>
                </div>
            </div>
        </div>
    </x-layout.profile>
