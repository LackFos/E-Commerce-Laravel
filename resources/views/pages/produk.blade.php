                    ...
                    <div class="flex flex-col gap-8">
                        <div class="flex items-center gap-4">
                            <div class="flex items-center justify-between p-4 bg-gray-300 rounded-full w-36">
                                <button class="text-3xl font-bold w-9">-</button>
                                <input type="text" placeholder="1" class="w-[6px] text-black bg-transparent placeholder:text-base placeholder:text-black">
                                <button class="text-3xl font-bold w-9">+</button>
                            </div>
