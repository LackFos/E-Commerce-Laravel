    ...
    <div class="flex gap-2">
        <div class="flex w-full max-w-[1440px]">
            ...
            <x-layout.content>
                ...
                <form action="{{ route('banner.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col w-full gap-6 p-10">
                @csrf
                ...
                <div class="flex flex-col w-full bg-white border border-gray-200 border-solid rounded-lg">
                    ...
                    <div class="flex gap-6 px-6 py-4">
                        ...
                        <input class="w-1/2 px-4 py-1 border border-gray-200 border-solid rounded-lg" type="text" name="name" value={{ old('name') }}>
                    </div>
