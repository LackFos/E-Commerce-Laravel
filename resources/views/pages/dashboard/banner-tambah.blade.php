    ...
    <x-layout.admin>
        ...
        <div class="flex gap-2">
            <div class="flex w-full">
                ...
                <form action="{{ route('banner.store') }}" method="POST" enctype="multipart/form-data" class="flex w-full flex-col gap-6 p-10">
                    @csrf
                    ...
                    <div class="flex w-full flex-col rounded-lg border border-solid border-gray-200 bg-white">
                        ...
                        <div class="flex gap-6 px-6 py-4">
                            ...
                            <input class="w-1/2 rounded-lg border border-solid border-gray-200 px-4 py-1" type="text" name="name" value={{ old('name') }}>
                        </div>
