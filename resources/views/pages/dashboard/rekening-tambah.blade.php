            ...
            <form class="flex w-full flex-col gap-6 p-10">
                ...
                <div class="flex w-full flex-col rounded-lg border border-solid border-gray-200 bg-white">
                    ...
                    <div class="flex gap-6 px-6 py-2">
                        ...
                        <input placeholder="Masukan Nama Penerima" class="w-1/2 rounded-lg border border-solid border-gray-200 px-4 py-1" type="text" name="" id="">
                    </div>
                    <div class="flex gap-6 px-6 py-2">
                        <div class="flex w-1/2 flex-col justify-start gap-1">
                            <span class="font-medium leading-8">Nama Bank:</span>
                        </div>
                        <input placeholder="Masukan Nama Bank" class="w-1/2 rounded-lg border border-solid border-gray-200 px-4 py-1" type="text" name="" id="">
                    </div>
                    <div class="flex gap-6 px-6 py-2">
                        <div class="flex w-1/2 flex-col justify-start gap-1">
                            <span class="font-medium leading-8">No Rekening:</span>
                        </div>
                        <input placeholder="Masukan No Rekening" class="w-1/2 rounded-lg border border-solid border-gray-200 px-4 py-1" type="number" name="" id="">
                    </div>
                </div>
