            ...
            <div class="flex w-full">
                <div class="flex flex-col w-full gap-6 p-10">
                    ...
                    <form class="flex w-full gap-6 p-6 bg-white rounded-lg">
                        ...
                        <select id="sort" name="sort" class="w-[20%] rounded-md bg-slate-200 py-2 px-3 text-base text-black">
                        ...
                        <button type="submit" class="flex items-center justify-center px-4 py-1 font-semibold text-white rounded-md whitespace-nowrap bg-primary">Terapkan
                            Filter
                        </button>
                    </form>
