            ...
            <div class="flex w-full">
                <div class="flex w-full flex-col gap-6 p-10">
                    ...
                    <form class="flex w-full gap-6 rounded-lg bg-white p-6">
                        <input placeholder="Cari nama barang" class="w-2/5 rounded-lg border border-solid border-gray-200 px-4 py-1" type="text" name="sort" id="sort">
                        ...
                        <button type="submit" class="flex items-center justify-center whitespace-nowrap rounded-md bg-primary px-4 py-1 font-semibold text-white">Terapkan
                            Filter</button>
                    </form>
